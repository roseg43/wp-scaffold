 ...
 *
 * @package TenUpTheme\Blocks\AuthorByline
 */

namespace TenUpTheme\Blocks\AuthorByline;
...
function register() {
	...
	register_block_type_from_metadata(
		TENUP_THEME_BLOCK_DIR . '/author-byline', // this is the directory where the block.json is found.
		[
...
function render_block_callback( $attributes, $content, $block ) {
	ob_start();
	get_template_part(
		'includes/blocks/author-byline/markup',
		null,
		[
